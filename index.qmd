...
block_letter = create_block_letter_s(h, w, letter="S", font_size_ratio=0.95)
...
- The meme demonstrates selection bias because only the stippled dots inside the block letter “S” are shown in the “Estimate” panel, making that region appear more meaningful or structured than it actually is.

- This selective reveal hides the majority of the stipple pattern, which is visible in the full “Your Model” panel and shows a much more complex and noisy distribution.
